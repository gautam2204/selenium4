...
public class NodePlay {
    final static Logger logger = LoggerFactory.getLogger(NodePlay.class);
...
//      driver.get("https://www.selenium.dev/selenium/web/devToolsRequestInterceptionTest.html");
      driver.get("https://www.selenium.dev/selenium/web/actualXhtmlPage.xhtml");
...
//              pierce = 0
      ...
      Node doc = devTools.send(DOM.getDocument(Optional.of(-1), Optional.of(Boolean.TRUE)));
